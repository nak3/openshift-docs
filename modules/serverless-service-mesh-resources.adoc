...
[IMPORTANT]
====
{product-title} route must be created in the same namespace with your ServiceMeshControlPlane. In this example, ServiceMeshControlPlane is deployed in `istio-system` namespace.
====
